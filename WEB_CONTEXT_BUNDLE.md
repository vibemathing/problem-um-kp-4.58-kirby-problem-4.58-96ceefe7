...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.58-kirby-problem-4.58-96ceefe7-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.58"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.58-kirby-problem-4.58-96ceefe7-v1",
      "problem_contract_sha256": "a4a6e505c609ac476e59856de95d16d393703b374d09925615e769cdb0b91d04",
      "problem_id": "problem:um-kp-4.58-kirby-problem-4.58-96ceefe7",
      "route_id": "route:um-kp-4.58-kirby-problem-4.58-96ceefe7-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.58-kirby-problem-4.58-96ceefe7-source-fidelity-01",
      "graph_id": "graph:um-kp-4.58-kirby-problem-4.58-96ceefe7-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.58-kirby-problem-4.58-96ceefe7-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.58-kirby-problem-4.58-96ceefe7-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(a) Which Seifert fibered homology spheres $\\Sigma(a_{1}$, . . . , $a_{n})bound$ acyclic manifolds? Are there any examples with four or more singular fibers that bound acyclic manifolds? (b) Which Seifert fibered homology spheres bound contractible manifolds? Is there an example that bounds an acyclic manifold but not a contractible manifold? (c) Are there any Seifert fibered homology spheres that arise as cork boundaries?"
          },
          "statement_sha256": "05f1142ba499b86f5dbcc2f7fd0cedd8d8991d28a6fc553a0df266554aea5611"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.58-kirby-problem-4.58-96ceefe7-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.58-kirby-problem-4.58-96ceefe7-root",
      "route_id": "route:um-kp-4.58-kirby-problem-4.58-96ceefe7-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.58-9323b5f9c6f4",
        "url": "https://www.unsolvedmath.com/problems/KP-4.58"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
